...
class SimCLR(object):
    def __init__(self, 
        ...
        Args:
            model (pytorch model): torch model
            model_name (str): model name
            scheduler (pytorch scheduler): pytorch scheuduler
    ...
    def train(self, train_loader):
        ...
        print(f"Start SimCLR training for {self.epochs} epochs.")
        print(f"Training with: {self.device} device.")
        print(f"SimCLR Setting: {self.metadata}\n")    
        ...
        torch.save(self.model.state_dict(), f'checkpoint_name')
        
        # logging.info(f"Model checkpoint and metadata has been saved at {self.writer.log_dir}.")
        print(f"Model checkpoint has been saved at {checkpoint_name}.")